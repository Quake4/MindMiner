...
switch ([Config]::CudaVersion) {
	([version]::new(10, 0)) { $url = "https://github.com/trexminer/T-Rex/releases/download/0.8.1/t-rex-0.8.1-win-cuda10.0.zip" }
	([version]::new(9, 2)) { $url = "https://github.com/trexminer/T-Rex/releases/download/0.8.1/t-rex-0.8.1-win-cuda9.2.zip" }
	default { $url = "https://github.com/trexminer/T-Rex/releases/download/0.8.1/t-rex-0.8.1-win-cuda9.1.zip" }
}
