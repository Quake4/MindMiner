...
$url = "https://github.com/KlausT/ccminer/releases/download/8.24/ccminer-824-cuda92-x64.zip";
if ([Config]::CudaVersion -ge [version]::new(10, 0)) {
	$url = "https://github.com/KlausT/ccminer/releases/download/8.24/ccminer-824-cuda10-x64.zip"
}
