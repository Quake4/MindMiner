...
if ([Config]::Is64Bit -eq $true) {
	$url = "https://github.com/lenis0012/ccminer/releases/download/2.3.0-allium/ccminer-x64.exe"
	$file = "ccminer-x64.exe"
}
else {
	$url = "https://github.com/lenis0012/ccminer/releases/download/2.3.0-allium/ccminer-x86.exe"
	$file = "ccminer-x86.exe"
}
