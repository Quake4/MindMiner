...
switch ([Config]::CudaVersion) {
	{ $_ -ge [version]::new(10, 1) } { $url = "https://github.com/zealot-rvn/z-enemy/releases/download/kawpow206/z-enemy-2.6-win-cuda10.1.zip" }
	([version]::new(10, 0)) { $url = "https://github.com/zealot-rvn/z-enemy/releases/download/kawpow206/z-enemy-2.6-win-cuda10.0.zip" }
	([version]::new(9, 2)) { $url = "https://github.com/zealot-rvn/z-enemy/releases/download/kawpow206/z-enemy-2.6-win-cuda9.2.zip" }
	default { $url =  "https://github.com/zealot-rvn/z-enemy/releases/download/kawpow206/z-enemy-2.6-win-cuda9.1.zip" }
}
