...
$AMD = @("aeternity", "beamhash", "beamhashII", "eaglesong", "equihash125", "equihash144", "equihash192", "swap", "zhash")
				...
				$types | ForEach-Object {
					if ($_) {
						...
						[MinerInfo]@{
							...
							TypeInKey = $true
							API = "gminer"
							URI = "https://github.com/develsoftware/GMinerRelease/releases/download/1.67/gminer_1_67_windows64.zip"
							Path = "$Name\miner.exe"
							ExtraArgs = $extrargs
