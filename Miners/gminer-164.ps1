...
$AMD = @("aeternity", "beamhash", "beamhashII", "equihash125", "equihash144", "equihash192", "swap", "zhash")
				...
				$types | ForEach-Object {
					if ($_) {
						...
						[MinerInfo]@{
							...
							TypeInKey = $true
							API = "gminer"
							URI = "https://github.com/develsoftware/GMinerRelease/releases/download/1.64/gminer_1_64_windows64.zip"
							Path = "$Name\miner.exe"
							ExtraArgs = $extrargs
