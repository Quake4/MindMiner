...
$url = if ([Config]::Is64Bit -eq $true) { "http://mindminer.online/miners/nVidia/z-enemy.117-92-x32.zip" } else { "http://mindminer.online/miners/nVidia/z-enemy.117-91-x32.zip" }
