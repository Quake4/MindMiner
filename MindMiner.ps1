...
while ($true)
{
	...
	if (!$exit) {
		...
		$unique = $AllMiners | Where-Object { $_.Miner.Priority -eq [Priority]::Unique } | Select-Object -First 1

		if ($global:HasConfirm -and (!($AllMiners | Where-Object { $_.Speed -eq 0 } | Select-Object -First 1) -or $unique)) {
